#!/usr/bin/env python3
"""
LinkedIn Graphic — GIAIC Agent Factory Class
Premium split-panel design | 2x supersampled | 1080x1350 px
"""
...
# ==============================================================================
#  CONTENT  ←  ALL post text lives here. Change only this block for new posts.
# ==============================================================================

CATEGORY = "G I A I C   ·   A G E N T   F A C T O R Y   C L A S S   ·   2 0 2 6"

# Headline: list of (text, font_size) tuples — 2 or 3 lines
# Line 1: shorter intro phrase (60–65 pt)
# Line 2: bold main statement (78–84 pt)
# Line 3: payoff / punch (78–84 pt)  ← optional, omit to use 2-line headline
HEADLINE = [
    ("The Future Doesn't",  62),
    ("Hire Software.",       80),
    ("It Hires AI.",         80),
]

# One micro-label per card, joined by  ·  in the sub-tag line
SUBLINE = "Digital FTEs   ·   Prompting 2026   ·   Markdown"

# Three content cards — one per key topic
CARDS = [
    dict(
        tag  = "AGENT FACTORY",
        title= "Digital FTEs",
        sub  = "AI Employees — Not Just Tools",
        sub2 = "168 hrs/week  ·  $500–2K/month",
        det  = "10% Human Intent  →  80% AI  →  10% Verify",
    ),
    dict(
        tag  = "PROMPTING 2026",
        title= "13 Core Principles",
        sub  = "Brief AI Like a Smart Colleague",
        sub2 = "Context · Files · Constraints · Clear Ask",
        det  = "Brainstorm Loop  ·  Anti-Sycophancy  ·  3 Retrieval Modes",
    ),
    dict(
        tag  = "UNIVERSAL SYNTAX",
        title= "Markdown",
        sub  = "The Language of AI Agents",
        sub2 = "Human + Machine Readable",
        det  = "Agent Specs  ·  Prompts  ·  Handoffs",
    ),
]

CREATOR  = "Syeda Gulzar Bano"
ORG_LINE = "GIAIC  ·  Mentor: Sir Anas  ·  June 14, 2026"
HASHTAGS = "#GIAIC    #AgentFactory    #AIWorkforce    #Panaversity"
...
# Card colors: [left-panel deep], [ghost watermark], [right-panel tint]
...
def build():
    ...
    # 6. Category label with flanking lines
    f_cat = JURA(12)
    ...
    # 9. Node circles (straddle header/content boundary)
    BY   = 444
    NXS  = [238, 540, 842]
    ...
    for i, card in enumerate(CARDS):
        ...
        # Full card (right-panel tint)
        rr(d, (CX1, y1, CX2, y2), CR, fill=rp)

        # Left colored panel (rounded left, flat right)
        ...
        # Tag label (white, bottom-center of left panel)
        ...
        # Accent dot (top-right of right panel)
    ...
    # 14. Downsample 2x → 1x (LANCZOS for crisp anti-aliasing)
    img = img.resize((W, H), Image.LANCZOS)
    img.save(OUT, "PNG", dpi=(300, 300))
    print(f"Saved: {OUT}")
    print(f"Rendered at {W2}x{H2}, downsampled to {W}x{H}")
