...
description: "Professional LinkedIn Content Writer — transforms any technical learning, class notes, book chapters, or workshop content into a polished, scroll-stopping LinkedIn post (200–300 words). Handles hooks, insight bullets, engagement questions, hashtags, and mentions. Use whenever a user wants to write a LinkedIn post about what they learned, built, or want to share."
---
...
Before writing, internally map the content to this structure:
